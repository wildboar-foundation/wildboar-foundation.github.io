...
_A 3d-array `X` and a 3d-array `Y`_
...
By setting `dim` to the desired dimension, we avoid computing the distance
...
We can request the _best matching index_, i.e., the index where the minimum
